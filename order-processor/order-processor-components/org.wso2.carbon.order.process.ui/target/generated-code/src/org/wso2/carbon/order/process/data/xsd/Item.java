 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                name = Item
                Namespace URI = http://data.process.order.carbon.wso2.org/xsd
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://data.process.order.carbon.wso2.org/xsd");
                ...
                if (localNameTracker){
                                    namespace = "http://data.process.order.carbon.wso2.org/xsd";
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://data.process.order.carbon.wso2.org/xsd")){
                return "ns1";
            }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localNameTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://data.process.order.carbon.wso2.org/xsd",
                                                                      "name"));
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Item".equals(type)){
                                ...
                                return (Item)org.wso2.carbon.order.process.data.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://data.process.order.carbon.wso2.org/xsd","name").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://data.process.order.carbon.wso2.org/xsd","price").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://data.process.order.carbon.wso2.org/xsd","quantity").equals(reader.getName())){
