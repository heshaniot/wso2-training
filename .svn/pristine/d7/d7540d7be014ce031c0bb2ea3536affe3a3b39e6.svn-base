...
public class OrderProcessingClient {
	...
	private static EndpointReference targetEPR = 
	        new EndpointReference("http://localhost:8080/axis2/services/OrderProcessingService");
	    ...
	    public static void main(String[] args) {
	        try {
	        	...
	        	OMElement getPricePayload = getPricePayload("Pens");
	           ...
	           // sender.fireAndForget(addOrderPayload1);
	            ...
	            System.err.println("Price of Pens: " + response0);
